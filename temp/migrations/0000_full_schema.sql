...
-- ── CONSTRAINTS ──────────────────────────────────────────────────────────────
--> statement-breakpoint
ALTER TABLE "bookings" DROP CONSTRAINT IF EXISTS "bookings_amounts_match_check";
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "time_slots" DROP CONSTRAINT IF EXISTS "time_slots_price_check";
--> statement-breakpoint
ALTER TABLE "time_slots"
  ADD CONSTRAINT "time_slots_price_check"
  CHECK ("price" BETWEEN 100 AND 100000);
--> statement-breakpoint
ALTER TABLE "turfs" DROP CONSTRAINT IF EXISTS "turfs_price_check";
--> statement-breakpoint
ALTER TABLE "turfs"
  ADD CONSTRAINT "turfs_price_check"
  CHECK ("price_per_hour" BETWEEN 100 AND 100000 AND "weekend_surcharge" BETWEEN 0 AND 50000);
--> statement-breakpoint
ALTER TABLE "slot_holds" DROP CONSTRAINT IF EXISTS "slot_holds_status_check";
--> statement-breakpoint
...
-- ── FOREIGN KEYS ─────────────────────────────────────────────────────────────
--> statement-breakpoint
ALTER TABLE "turf_staff" DROP CONSTRAINT IF EXISTS "turf_staff_owner_fk";
--> statement-breakpoint
ALTER TABLE "turf_staff" ADD CONSTRAINT "turf_staff_owner_fk"
  FOREIGN KEY ("owner_id") REFERENCES "turf_owners"("id");
--> statement-breakpoint
ALTER TABLE "booking_slots" DROP CONSTRAINT IF EXISTS "booking_slots_booking_fk";
--> statement-breakpoint
ALTER TABLE "booking_slots" ADD CONSTRAINT "booking_slots_booking_fk"
  FOREIGN KEY ("booking_id") REFERENCES "bookings"("id") ON DELETE CASCADE;
--> statement-breakpoint
ALTER TABLE "booking_slots" DROP CONSTRAINT IF EXISTS "booking_slots_slot_fk";
--> statement-breakpoint
ALTER TABLE "booking_slots" ADD CONSTRAINT "booking_slots_slot_fk"
  FOREIGN KEY ("slot_id") REFERENCES "time_slots"("id");
--> statement-breakpoint
ALTER TABLE "booking_payments" DROP CONSTRAINT IF EXISTS "booking_payments_booking_fk";
--> statement-breakpoint
ALTER TABLE "booking_payments" ADD CONSTRAINT "booking_payments_booking_fk"
  FOREIGN KEY ("booking_id") REFERENCES "bookings"("id");
--> statement-breakpoint
ALTER TABLE "turf_images" DROP CONSTRAINT IF EXISTS "turf_images_turf_fk";
--> statement-breakpoint
ALTER TABLE "turf_images" ADD CONSTRAINT "turf_images_turf_fk"
  FOREIGN KEY ("turf_id") REFERENCES "turfs"("id") ON DELETE CASCADE;
--> statement-breakpoint
ALTER TABLE "turf_amenities" DROP CONSTRAINT IF EXISTS "turf_amenities_turf_fk";
--> statement-breakpoint
ALTER TABLE "turf_amenities" ADD CONSTRAINT "turf_amenities_turf_fk"
  FOREIGN KEY ("turf_id") REFERENCES "turfs"("id") ON DELETE CASCADE;
--> statement-breakpoint
ALTER TABLE "turf_sport_types" DROP CONSTRAINT IF EXISTS "turf_sport_types_turf_fk";
--> statement-breakpoint
ALTER TABLE "turf_sport_types" ADD CONSTRAINT "turf_sport_types_turf_fk"
  FOREIGN KEY ("turf_id") REFERENCES "turfs"("id") ON DELETE CASCADE;
--> statement-breakpoint
ALTER TABLE "turf_applications" DROP CONSTRAINT IF EXISTS "turf_applications_owner_fk";
--> statement-breakpoint
